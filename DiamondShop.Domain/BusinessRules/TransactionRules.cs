...
namespace DiamondShop.Domain.BusinessRules
{
    ...
    {
        public static TransactionRule Default = new TransactionRule();
        public static string Type = typeof(TransactionRule).AssemblyQualifiedName;
        public static string key = "TransactionRule";
        public long MinimumPerTransaction { get; set; } = 10000;// 10k
        public long MaximumPerTransaction { get; set; } = 50000000;//200tr
        public static string TransactionTimeStamp { get; set; } = "yyyyMMddHHmmss";
    }
}
