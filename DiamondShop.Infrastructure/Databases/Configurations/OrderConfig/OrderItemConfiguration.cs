...
namespace DiamondShop.Infrastructure.Databases.Configurations.OrderConfig
{
    internal class OrderItemConfiguration : IEntityTypeConfiguration<OrderItem>
    {
        public void Configure(EntityTypeBuilder<OrderItem> builder)
        {
            ...
            builder.HasOne(o => o.Jewelry).WithOne().HasForeignKey<OrderItem>(o => o.JewelryId).IsRequired(false).OnDelete(DeleteBehavior.SetNull);
            builder.HasOne(o => o.Diamond).WithOne().HasForeignKey<OrderItem>(o => o.DiamondId).IsRequired(false).OnDelete(DeleteBehavior.SetNull);
