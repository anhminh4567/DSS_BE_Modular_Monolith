...
namespace DiamondShop.Infrastructure.Migrations
{
    ...
    [Migration("20241212055603_UpdateRelationCustomizeJewelry")]
    partial class UpdateRelationCustomizeJewelry
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DiamondShop.Application.Services.Models.DbCacheModel", b =>
                {
            ...
            modelBuilder.Entity("DiamondShop.Domain.Models.DiamondPrices.DiamondPrice", b =>
                {
                    ...
                    b.Property<string>("OldAccountIdUpdate")
                        .HasColumnType("text");

                    b.Property<decimal?>("OldPrice")
                        .HasColumnType("numeric");

                    b.Property<DateTime?>("OldUpdatedAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasIndex("IsLabDiamond", "IsSideDiamond");

                    b.HasIndex("CriteriaId", "IsLabDiamond", "IsSideDiamond");

                    b.HasIndex("CriteriaId", "IsLabDiamond", "IsSideDiamond", "Color", "Clarity")
                        .IsUnique();
            ...
            modelBuilder.Entity("DiamondShop.Domain.Models.DiamondPrices.Entities.DiamondCriteria", b =>
                {
                    ...
                    b.Property<DateTime?>("LastUpdatedTable")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasIndex("CaratFrom", "CaratTo", "IsSideDiamond");

                    b.HasIndex("ShapeId", "IsSideDiamond", "CaratFrom", "CaratTo");
            ...
            modelBuilder.Entity("DiamondShop.Domain.Models.Diamonds.Diamond", b =>
                {
                    ...
                    b.Property<decimal?>("FixPriceOffset")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("DiamondShop.Domain.Models.JewelryModels.Entities.Metal", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "3",
                            LocalizedName = "Vàng trắng 14k",
                            Name = "14K White Gold",
                            Price = 1217096m
                        },
                        new
                        ...
                        {
                            Id = "6",
                            LocalizedName = "Vàng trắng 16K",
                            Name = "16K White Gold",
                            Price = 1391318m
                        },
                        new
                        ...
                        {
                            Id = "9",
                            LocalizedName = "Vàng trắng 18K",
                            Name = "18K White Gold",
                            Price = 1565233m
                        },
                        new
            ...
            modelBuilder.Entity("DiamondShop.Domain.Models.Orders.Entities.OrderItem", b =>
                {
                    ...
                    b.Property<decimal?>("DiscountSavedAmount")
                        .HasColumnType("numeric");
                    ...
                    b.Property<decimal?>("PromotionSavedAmount")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("DiamondShop.Domain.Models.Orders.Order", b =>
                {
                    ...
                    b.Property<DateTime?>("FinishPreparedDate")
                        .HasColumnType("timestamp with time zone");

                    b.Property<bool?>("HasDelivererReturned")
                        .HasColumnType("boolean");

                    b.Property<bool>("IsCollectAtShop")
                        .HasColumnType("boolean");

                    b.Property<string>("Note")
                        .HasColumnType("text");

                    b.Property<decimal>("OrderAmountSaved")
                        .HasColumnType("numeric");
                    ...
                    b.Property<decimal>("ShippingFeeSaved")
                        .HasColumnType("numeric");
                    ...
                    b.Property<decimal>("TotalPromotionAmountSaved")
                        .HasColumnType("numeric");

                    b.Property<decimal>("TotalRefund")
                        .HasColumnType("numeric");

                    b.Property<decimal>("UserRankAmountSaved")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("DiamondShop.Domain.Models.Transactions.Entities.PaymentMethod", b =>
                {
                    ...
                    b.Property<decimal?>("MaxSupportedPrice")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("DiamondShop.Domain.Models.Warranties.Warranty", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1",
                            Code = "THREE_MONTHS",
                            CreateDate = new DateTime(2024, 12, 12, 5, 56, 2, 81, DateTimeKind.Utc).AddTicks(1471),
                            LocalizedName = "Bảo hành trang sức 3 tháng",
                            MonthDuration = 3,
                        ...
                        new
                        {
                            Id = "2",
                            Code = "THREE_MONTHS",
                            CreateDate = new DateTime(2024, 12, 12, 5, 56, 2, 81, DateTimeKind.Utc).AddTicks(1680),
                            LocalizedName = "Bảo hành kim cương 3 tháng",
                            MonthDuration = 3,
                        ...
                        new
                        {
                            Id = "3",
                            Code = "ONE_YEAR",
                            CreateDate = new DateTime(2024, 12, 12, 5, 56, 2, 81, DateTimeKind.Utc).AddTicks(1686),
                            LocalizedName = "Bảo hành trang sức 1 năm",
                            MonthDuration = 12,
                        ...
                        new
                        {
                            Id = "4",
                            Code = "ONE_YEAR",
                            CreateDate = new DateTime(2024, 12, 12, 5, 56, 2, 81, DateTimeKind.Utc).AddTicks(1688),
                            LocalizedName = "Bảo hành trang sức 1 năm",
                            MonthDuration = 12,
            ...
            modelBuilder.Entity("DiamondShop.Domain.Models.CustomizeRequests.CustomizeRequest", b =>
                {
                    ...
                    b.HasOne("DiamondShop.Domain.Models.Jewelries.Jewelry", "Jewelry")
                        .WithOne()
                        .HasForeignKey("DiamondShop.Domain.Models.CustomizeRequests.CustomizeRequest", "JewelryId")
            ...
            modelBuilder.Entity("DiamondShop.Domain.Models.Diamonds.Diamond", b =>
                {
                    ...
                    b.OwnsOne("DiamondShop.Domain.Common.ValueObjects.Media", "CertificateFilePath", b1 =>
                        {
                    ...
                    b.Navigation("CertificateFilePath");
            ...
            modelBuilder.Entity("DiamondShop.Domain.Models.Orders.Order", b =>
                {
                    ...
                    b.HasOne("DiamondShop.Domain.Models.CustomizeRequests.CustomizeRequest", "CustomizeRequest")
                        .WithOne("Order")
            ...
            modelBuilder.Entity("DiamondShop.Domain.Models.Transactions.Transaction", b =>
                {
                    ...
                    b.HasOne("DiamondShop.Domain.Models.AccountAggregate.Account", "Verifier")
                        .WithMany()
                        .HasForeignKey("VerifierId");

                    b.OwnsOne("DiamondShop.Domain.Common.ValueObjects.Media", "Evidence", b1 =>
                        {
