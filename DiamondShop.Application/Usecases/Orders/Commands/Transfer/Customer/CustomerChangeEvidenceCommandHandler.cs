...
{
    public record CustomerChangeEvidenceCommand(string AccountId, ChangeEvidenceRequestDto ChangeEvidenceRequestDto) : IRequest<Result>;
    internal class CustomerChangeEvidenceCommandHandler : IRequestHandler<CustomerChangeEvidenceCommand, Result>
    {
        private readonly ITransactionRepository _transactionRepository;
        private readonly ITransferFileService _transferFileService;
        private readonly IUnitOfWork _unitOfWork;
        public CustomerChangeEvidenceCommandHandler(ITransactionRepository transactionRepository, ITransferFileService transferFileService, IUnitOfWork unitOfWork)
        {
        ...
        public async Task<Result> Handle(CustomerChangeEvidenceCommand request, CancellationToken token)
        {
