...
{
    public record CustomizeDiamondRequest(string DiamondShapeId, Clarity clarityFrom, Clarity clarityTo, Color colorFrom, Color colorTo, Cut cutFrom, Cut cutTo, float caratFrom, float caratTo, bool? isLabGrown, Polish? polish, Symmetry? symmetry, Girdle? girdle, Culet? culet);
