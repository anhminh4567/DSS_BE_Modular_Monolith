...
{
    public record ChangedAddress(string[]? removedAddressId, Dictionary<string, AddressRequestDto>? updatedAddress, AddressRequestDto[]? addedAddress, string? newDefaultAddressId);
