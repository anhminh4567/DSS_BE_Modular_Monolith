...
namespace DiamondShop.Application.Usecases.Accounts.Commands.Update
{
    ...
    public record UpdateUserAccountRequest(FullName? ChangedFullName, ChangedAddress? ChangedAddress) : IRequest<Result<Account>>;
    public record UpdateUserAccountCommand(string userId, FullName? ChangedFullName, ChangedAddress? ChangedAddress): IRequest<Result<Account>>;
}
