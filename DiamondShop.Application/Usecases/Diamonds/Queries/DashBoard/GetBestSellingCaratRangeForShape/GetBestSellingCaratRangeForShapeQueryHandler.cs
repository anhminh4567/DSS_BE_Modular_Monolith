...
{
    public record GetBestSellingCaratRangeForShapeQuery(string shapeId, string caratFrom, string caratTo, string? startDate, string? endDate) : IRequest<Result<DiamondBestSellingCaratRangePerShapeDto>>;
    internal class GetBestSellingCaratRangeForShapeQueryHandler : IRequestHandler<GetBestSellingCaratRangeForShapeQuery, Result<DiamondBestSellingCaratRangePerShapeDto>>
    {
        ...
        public async Task<Result<DiamondBestSellingCaratRangePerShapeDto>> Handle(GetBestSellingCaratRangeForShapeQuery request, CancellationToken cancellationToken)
        {
            ...
            return new DiamondBestSellingCaratRangePerShapeDto
            {
                Shape = _mapper.Map<DiamondShapeDto>(getShape),
                TotalSold = totalSold,
                TotalRevenue = totalRevenue.Value,
                SoldDiamondIds = soldIds
            };
        }
    }
}
