...
namespace DiamondShop.Application.Usecases.Diamonds.Queries.GetPaging
{
    ...
    public record GetDiamondPagingQuery(bool? includeJewelryDiamond = false, int pageSize = 20, int start = 0, string? shapeId = "1", decimal priceStart = 0, decimal priceEnd = decimal.MaxValue,
