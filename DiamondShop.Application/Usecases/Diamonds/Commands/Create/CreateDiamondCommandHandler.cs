...
{
    public record CreateDiamondCommand(Diamond_4C diamond4c, Diamond_Details details, Diamond_Measurement measurement, string shapeId, decimal priceOffset = 1) :IRequest<Result<Diamond>>;
    internal class CreateDiamondCommandHandler : IRequestHandler<CreateDiamondCommand, Result<Diamond>>
    {
        ...
        {
            request.Deconstruct(out var diamond4c, out var details, out var measurement, out string shapeGivenId, out var priceOffset);
            ...
            Diamond newDiamond = Diamond.Create(getShape, diamond4c, details, measurement, priceOffset);
