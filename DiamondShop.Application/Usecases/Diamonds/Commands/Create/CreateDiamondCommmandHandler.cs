...
namespace DiamondShop.Application.Usecases.Diamonds.Commands.Create
{
    ...
    internal class CreateDiamondCommmandHandler : IRequestHandler<CreateDiamondCommand, Result<Diamond>>
    {
        ...
        {
            request.Deconstruct(out var diamond4c, out var details, out var measurement, out bool hasGIA, out string shapeGivenId);
            ...
            Diamond newDiamond = Diamond.Create(getShape, diamond4c, details, hasGIA, measurement);
